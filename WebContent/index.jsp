...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <link href="https://fonts.googleapis.com/css?family=Dancing+Script|Yanone+Kaffeesatz" rel="stylesheet">
...
.container-hover .box .imgBox {
    position:relative;
}
.container-hover .box .imgBox img {
    width:100%;
    transition:0.5s;
}
.container-hover .box:hover .imgBox img {
    opacity:.2;
    transform:scale(1.2);
}
...
.container-hover .box:hover .content h2,
.container-hover .box:hover .content P {
    opacity:1;
    visibility:visible;
...
.jumbotron{
    margin-top:30px;
    background:linear-gradient(rgba(60, 65, 73,0.7),rgba(60, 65, 73,0.7)),url(http://cdn8.bigcommerce.com/s-t9jlg6/product_images/theme_images/slide-1.png?t=1516361892) repeat fixed 100%;
...
<div class="container">
<br><br><br><br><br>
<h1 style="font-family: 'Yanone Kaffeesatz', sans-serif;font-size:60px; " id="lbShopby">Shop By:</h1>
<hr><br><br><br>
</div>

<div class="offset-lg-2" style="float: left;" >
...
<div class="container-hover" style="float:left">
 <div class="box" data-aos="fade-center">
        <div class="imgBox"  >
            <img src="https://colorlib.com/etc/fashe/images/banner-03.jpg"  class="img-fluid" style="height: 400px;"  >
        </div>
        <div class="content">
            <h2>Collections</h2>
            <p>
...
<div class="container-hover" style="float:left;margin-bottom:160px">
 <div class="box" data-aos="fade-right">
        <div class="imgBox"  >
            <img src="https://colorlib.com/etc/fashe/images/banner-04.jpg"  class="img-fluid" style="height: 400px;" id="banner4"  >
        </div>
        <div class="content">
            <h2>Bags</h2>
            <p>
...
<div class="container-hover" >
 <div class="box" data-aos="fade-bottom" >
        <div class="imgBox"  >
            <img src="https://colorlib.com/etc/fashe/images/banner-05.jpg"  class="img-fluid" style="height: 400px;"  >
        </div>
        <div class="content">
            <h2>Sun Glasses</h2>
            <p>
...
<div class="container-hover" style="float:left; margin-left:100px; margin-right:500px; margin-bottom:300px;">
 <div class="box" data-aos="fade-right">
        <div class="imgBox"  >
            <img src="https://colorlib.com/etc/fashe/images/banner-07.jpg"  id="banner07" class="img-fluid" style="height: 400px;"  >
        </div>
        <div class="content">
            <h2>Footwear</h2>
            <p>
