...
<li class="nav-item active">
       ...
       <a  href="MensBlog-NoSession.jsp" class="nav-link">Mens</a>
      ...
      <div class="dropdown-menu" role="group">
         ...
         <a class="dropdown-item" href="#">Boys Footwear</a>
         <a class="dropdown-item" href="#">Girls Footware</a>
         <a class="dropdown-item" href="#">Kids Accessories</a>
         <a class="dropdown-item" href="#">Brans</a>   
       </div>
    </div>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0">
          ...
          <a href="Html/Login.html"><button type="button" class="btn btn-warning btn-md" href="/Html/Login.html">Login</button></a>
</div>
    </form>
  </div>
</nav>
